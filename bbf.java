public class bbf {
    ...
    //git eh controle de versoes
    public static void main(String[] args) {
        System.out.println("Principais comandos do Git:");
        ...
        System.out.println("7. git push - Envia as alterações locais para o repositório remoto");
        System.out.println("8. git branch - Lista as branches locais");
        System.out.println("9. git checkout <nome da branch> - Muda para uma branch específica");
        System.out.println("10. git merge <nome da branch> - Mescla uma branch na branch atual");
